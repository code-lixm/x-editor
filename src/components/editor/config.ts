    ...
    toolbar: {
      ...
      tableAddTool: {
        ...
        view: {
          ...
          useTextbusStyleLabel: '使用默认样式',
        },
      },
      tableEditTool: {
        tooltip: '编辑表格',
        addColumnToLeft: '左侧添加一列',
        addColumnToRight: '右侧添加一列',
        insertRowBefore: '前侧插入一行',
        insertRowAfter: '后侧插入一行',
        deleteLeftColumn: '删除左侧一列',
        deleteRightColumn: '删除右侧一列',
        deletePrevRow: '删除前一行',
        deleteNextRow: '删除后一行',
        mergeCells: '合并单元格',
        splitCells: '取消合并单元格',
    ...
    jumbotronComponent: {
      ...
      setting: {
        ...
        form: {
          ...
          cancelBtnText: '取消',
          minHeightLabel: '巨幕高度',
          minHeightInputPlaceholder: '请输入巨幕高度',
